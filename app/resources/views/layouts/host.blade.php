            ...
            <div class="flex flex-col pt-1 space-y-3 bg-gray-800 w-80">
                ...
                <nav class="flex flex-col flex-1 px-3">
                    <ul class="flex flex-col space-y-3 text-gray-400">
                        ...
                        <li class="">
                            <a class="flex items-center p-2 space-x-4 bg-gray-800 rounded-lg hover:bg-gray-700 group" href="{{ route('host.properties.index') }}" wire:navigate.hover>
                                <svg class="w-7 h-7 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="flex flex-col h-full overflow-y-auto bg-gray-200">
                ...
                <div class="page-container">
                    <div class="page-header">
                        <div class="flex items-center justify-between page-x-padding">
