...
<div class="flex flex-1 flex-col" x-data="{ sidebar: false }">
    {{-- Topbar --}}
    <div class="flex-none py-1 shadow-xl">
        <div class="flex justify-between">
            ...
            {{-- Logo --}}
            <div class="tablet:min-w-80 flex items-center tablet:justify-center">
    ...
    <div class="relative flex h-full w-full overflow-hidden bg-gray-800">
        ...
        <div class="absolute inset-0 z-10 bg-gray-800/60 animate-in fade-in tablet:hidden" x-show="sidebar" x-cloak x-on:click="sidebar = false"></div>

        {{-- Sidebar --}}
        <div class="fixed z-20 -mt-1 hidden h-full w-auto duration-500 animate-in slide-in-from-left tablet:static tablet:flex tablet:flex-none tablet:animate-none" :class="sidebar ? '!flex' : 'hidden'">
        ...
        {{-- Content --}}
        <div class="h-full w-full overflow-hidden rounded-none bg-gray-800 tablet:rounded-tl-2xl">
