...
<div class="flex flex-col flex-1" x-data="{ sidebar: false }">
    ...
    <div class="relative flex w-full h-full overflow-hidden bg-gray-800">
        ...
        {{-- Sidebar --}}
        <div class="fixed z-20 hidden w-auto h-full -mt-1 duration-500 animate-in slide-in-from-left tablet:static tablet:flex tablet:flex-none tablet:animate-none" :class="sidebar ? '!flex' : 'hidden'">
