<div class="flex hidden h-full flex-col overflow-hidden" x-data="{ sidebar: false }">
    ...
    <div class="relative flex h-full overflow-hidden">
        ...
        {{-- Sidebar --}}
        <!-- Sidebar -->
        <section class="hide-scrollbar z-30 h-full w-full flex-none overflow-y-auto bg-gray-800 px-3 py-5 tablet-sm:w-64 tablet-sm:pt-0 tablet:!static tablet:!block" :class="sidebar ? 'absolute' : 'hidden'" x-cloak>
                            ...
                            <span class="flex w-full items-center justify-between">
                                <span class="flex min-w-0 items-center justify-between space-x-3">
                                    ...
                                    <span class="flex min-w-0 flex-1 flex-col justify-end">
                                        <span class="block truncate text-base font-semibold text-white tablet-sm:text-sm">Ohana Burnside</span>
                                        <span class="block truncate text-sm font-medium text-muted-dark tablet-sm:text-xs" :class="open && '!text-blue-300'">ohana-burnside</span>
                                    </span>
                                </span>
                                <svg class="h-8 w-8 shrink-0 text-muted group-hover:text-white tablet-sm:h-5 tablet-sm:w-5" :class="open && 'text-white'" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <div class="absolute z-10 mt-3 w-full overflow-hidden rounded-md bg-white text-gray-800 drop-shadow-lg" x-show="open" x-transition x-on:click.away="open = false" x-cloak>
                            <div class="flex max-h-[257px] flex-col divide-y overflow-y-auto">
                                ...
                                <button class="flex w-full items-center justify-between p-3 text-left hover:bg-gray-100">
                                    ...
                                    <svg class="h-8 w-8 shrink-0 text-green-500 group-hover:text-white tablet-sm:h-5 tablet-sm:w-5" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <ul class="flex flex-col gap-y-3 font-semibold">
                        <li>
                            <a class="{{ request()->routeIs('host.dashboard') ? 'bg-primary text-white' : '' }} group flex items-center justify-start space-x-3 rounded-md px-3 py-2" href="{{ route('host.dashboard') }}" wire:navigate.hover>
                                <svg class="{{ request()->routeIs('host.dashboard') ? 'text-white' : 'text-muted-dark group-hover:text-primary-light' }} h-8 w-8 tablet:h-6 tablet:w-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <span class="{{ request()->routeIs('host.dashboard') ? '' : 'text-muted group-hover:text-white' }} text-lg tablet:text-base">Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a class="{{ request()->routeIs('host.inbox') ? 'bg-primary text-white' : 'hover:bg-gray-700/50' }} group flex items-center justify-start space-x-3 rounded-md px-3 py-2" href="" wire:navigate.hover>
                                <svg class="{{ request()->routeIs('host.inbox') ? '' : 'text-muted-dark group-hover:text-primary-light' }} h-8 w-8 tablet:h-6 tablet:w-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"></path>
                                    <path d="M3 7l9 6l9 -6"></path>
                                </svg>
                                <span class="{{ request()->routeIs('host.inbox') ? '' : 'text-muted-light group-hover:text-white' }} text-lg tablet:text-base">Inbox</span>
                            </a>
                        </li>
                        <li>
                            <a class="{{ request()->routeIs('host.properties') ? 'bg-primary text-white' : 'hover:bg-gray-700/50' }} group flex items-center justify-start space-x-3 rounded-md px-3 py-2" href="/host/properties" wire:navigate.hover>
                                <svg class="{{ request()->routeIs('host.properties') ? '' : 'text-muted-dark group-hover:text-primary-light' }} h-8 w-8 tablet:h-6 tablet:w-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <span class="{{ request()->routeIs('host.properties') ? '' : 'text-muted-light group-hover:text-white' }} text-lg tablet:text-base">Properties</span>
                            </a>
                        </li>
                        <li>
                            <a class="{{ request()->routeIs('host.guests') ? 'bg-primary text-white' : 'hover:bg-gray-700/50' }} group flex items-center justify-start space-x-3 rounded-md px-3 py-2" href="" wire:navigate.hover>
                                <svg class="{{ request()->routeIs('host.guests') ? '' : 'text-muted-dark group-hover:text-primary-light' }} h-8 w-8 tablet:h-6 tablet:w-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <span class="{{ request()->routeIs('host.guests') ? '' : 'text-muted-light group-hover:text-white' }} text-lg tablet:text-base">Guests</span>
                            </a>
                        </li>
                        <li>
                            <a class="{{ request()->routeIs('host.settings') ? 'bg-primary text-white' : 'hover:bg-gray-700/50' }} group flex items-center justify-start space-x-3 rounded-md px-3 py-2" href="" wire:navigate.hover>
                                <svg class="{{ request()->routeIs('host.settings') ? '' : 'text-muted-dark group-hover:text-primary-light' }} h-8 w-8 tablet:h-6 tablet:w-6" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z"></path>
                                    <path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path>
                                </svg>
                                <span class="{{ request()->routeIs('host.settings') ? '' : 'text-muted-light group-hover:text-white' }} text-lg tablet:text-base">Settings</span>
                            </a>
                        </li>
                    </ul>
                </nav>
