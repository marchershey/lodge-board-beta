<div class="z-[5000] fixed top-0 w-full tablet-sm:max-w-md tablet-sm:right-0 tablet-sm:top-auto" x-data='ToastComponent($wire)' @mouseleave="scheduleRemovalWithOlder()">
