<div>
    <form class="card card-padding card-flex" wire:submit.prevent="submit" wire:init="load">
        ...
        <div class="card-form">
            ...
            <x-forms.select wiremodel="timezone" label="Default Timezone" desc="This is the timezone that you live in." placeholder="Select a timezone..." :options="$timezone_list" showKeyAsSelection />
        </div>
        <div>
